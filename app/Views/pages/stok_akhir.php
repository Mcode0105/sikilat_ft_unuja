...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                                ...
                                <?php foreach ($stokakhir as $br) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <a href="/home/on/<// $br['id_stok_akhir']; " class="btn btn-primary icon-round shadow"><i class="fas fa-power-off"></i></a> -->
                                            <!-- <a href="/home/off/ //$br'id_stok_akhir']; " class="btn btn-danger icon-round shadow"><i class="fas fa-power-off"></i></a> -->
                                            ...
                                            <button type="button" class="btn btn-outline-theme btn-round" data-toggle="modal" data-target=".bd-example-modalkeluar<?= $br['id_stok_akhir'] ?>"><i class="fa fa-sign-out"> Keluarkan</i></button>
                                            <?php if ($br['aktif'] == '1') : ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-justify">
                        ...
                        <form action="/home/tambahpeminjaman/<?= $br['id_stok_akhir']; ?> ?>" method="post" enctype="multipart/form-data">
                            ...
                            <?php csrf_field() ?>
                            <div class="form-group floating-label">
                                <select id="" class="custom-select" name="id_instansi">
                                    <?php foreach ($instansi as $kn) : ?>
                                        <option value="<?= $kn['id_instansi'] ?>"><?= $kn['instansi']; ?></option>
                                    <?php endforeach ?>
                                </select>
                                <label for="" class="mt-1">Instansi</label>
                            </div>
                            <div class="form-group floating-label">
    ...
    <?php foreach ($stokakhir as $st) : ?>
        <div class="modal fade bd-example-modalkeluar<?= $st['id_stok_akhir'] ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header text-center">
                    ...
                    <div class="modal-body text-justify">
                        <!--Floating label-->
                        <form action="/home/tambahpengeluaran/<?= $st['id_stok_akhir'] ?>">
                            <?= csrf_field() ?>
                            <input type="hidden" name="id" value="<?= $st['id_stok_akhir'] ?>">

                            <input type="hidden" name="id_kategori" value="<?= $st['id_kategori'] ?>">
                            <div class="form-group floating-label">
                                <input class="form-control" type="text" readonly required name="nama_barang" value="<?= $st['nama_barang'] ?>">
                                <label for="">Nama Barang</label>
                            </div>
                            <div class="form-group floating-label">
                                <input class="form-control" type="text" required name="jumlah">
                            ...
                            <div class="form-group floating-label">
                                <input class="form-control" type="date" name="waktu_pengeluaran">
