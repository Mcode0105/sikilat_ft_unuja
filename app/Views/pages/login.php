...
<body class="login-body">
    ...
    <div class="container-fluid login-wrapper">
        <div class="login-box">
            ...
            <h2 class="text-center mb-5">SIKILAT</h2>
            <div class="row">
                <div class="col-md-6 col-sm-6 col-12 login-box-info">
                    <h3 class="mb-4">Login Administrator</h3>
                    <p class="text-center"></a>SISTEM INFORMASI KOMPLAIN DAN LAYANAN TERPADU LABORATORIUM FAKULTAS TEKNIK UNIVERSITAS NURUL JADID</p>
                </div>
