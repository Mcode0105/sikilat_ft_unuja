...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
    ...
    <div class="row mt-3">
        <div class="col-sm-12">
            <a href="/home/laporanpeminjaman" target="_blank" class="btn btn-outline-success btn-round"><i class="fa fa-download"> Download laporan excel</i></a>
                            ...
                            <?php foreach ($peminjaman as $pj) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($pj['status'] == 1) : ?>
                                            ...
                                            <form class="d-inline" action="/home/barangkembali/<?= $pj['id_stok_akhir'] ?>" method="post">
                                                ...
                                                <button type="submit" class="badge badge-primary"> kembalikan </button>
                                            </form>
                                        <?php elseif ($pj['status'] == 2) : ?>
                                            <span class="badge badge-primary">Sudah Di kembalikan pada <?= $pj['updated_at'] ?></span>
                                        <?php endif ?>
                                    </td>
                                    <td>
                                        <?php if ($pj['konfir'] == 1) : ?>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-outline-theme btn-round" data-toggle="modal" data-target=".bd-example-modal-sm<?= $pj['id_peminjaman'] ?>"><i class=" fa fa-envelope"> </i></button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
    ...
    <!-- detail modal -->
    <?php foreach ($peminjaman as $pj) : ?>
        <div class="modal fade bd-example-modal-sm<?= $pj['id_peminjaman'] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-secondary"><strong>pengiriman Pesan sms</strong></h5>
                        <button type="button" class="close pull-right" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body text-justify">
                        <!--Floating label-->
                        <form action="/home/sendsms" method="post">
                            <div class="form-group floating-label">

                                <input type="hidden" name="no_hp" id="" value="<?= $pj['no_hp'] ?>">
